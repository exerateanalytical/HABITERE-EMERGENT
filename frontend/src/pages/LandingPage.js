  ...
  return (
    <div className="min-h-screen bg-white" data-testid="landing-page">
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-block px-6 py-3 bg-green-50 rounded-full mb-6 shadow-lg">
              <span className="text-sm md:text-base font-black text-green-600">Why Choose Habitere?</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 mb-6 tracking-tight">
              The Most Trusted Platform
              <span className="block mt-2 text-green-600">in Cameroon</span>
            </h2>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content */}
                  <h3 className="text-xl md:text-2xl font-black text-gray-900 mb-3 group-hover:text-green-600 transition-all duration-300">
                    {feature.title}
                  </h3>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-blue-50 via-blue-100/50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-block px-4 py-2 bg-green-600 rounded-full mb-6">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              Join <span className="font-bold text-green-600">10,000+ satisfied users</span> across Cameroon
            </p>
          </div>
