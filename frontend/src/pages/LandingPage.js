...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white" data-testid="landing-page">
      ...
      {/* Hero Section - Enhanced Desktop Design */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 pt-20 pb-16 sm:pt-24 sm:pb-20 md:pt-32 md:pb-28 lg:pt-40 lg:pb-32 safe-area-top">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center space-y-8 md:space-y-10">
            ...
            {/* Heading - Enhanced desktop typography */}
            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-tight tracking-tight">
                Find Your Perfect
                <span className="block mt-3 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300 animate-text-shimmer">
                  Home & Services
                </span>
                <span className="block mt-3 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-blue-100">
                  in Cameroon
                </span>
              </h1>
              
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-blue-50 leading-relaxed max-w-4xl mx-auto px-4 font-light">
