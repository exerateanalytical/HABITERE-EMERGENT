          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 lg:p-10">
            ...
            <div className="mb-8 space-y-4">
              ...
              <button
                ...
                type="button"
                className="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-4 px-6 rounded-2xl border-2 border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center group"
              >
