...
from routes import auth, properties, services, users, bookings, messages, reviews, core, images, payments, admin, security, assets, subscriptions, house_plans
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://plan-builder-8.preview.emergentagent.com",
        "http://localhost:3000",
        "http://localhost:8001"
    ],
